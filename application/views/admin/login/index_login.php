    ...
    <div class="page-login">
        <div class="login-box">
            <div class="login-logo">
                <div class="logo">
                    <img height="120px" src="<?=base_url();?>/public/img/logo.svg">
                </div>
                <a class="brand-name"
                    href="<?php echo base_url(); ?>"><?php echo $this->config->item('sitename'); ?></a>
            </div>
            <div class="login-box-body">
                ...
                <form action="<?php echo base_url('admin/login/validar/'); ?>" method="post">
                    <div class="form-group has-feedback"><input name="username" class="form-control"
                            placeholder="Usuario">
                    ...
                    <div class="alert alert-danger alert-dismissible"><button type="button" class="close"
                        ...
                        <div class="col-xs-4"><button type="submit"
                                class="btn btn-primary btn-block btn-flat">Ingresar</button></div>
                    </div>
                </form>
            </div>
        </div>
