...
class Prestamo extends MY_Controller {
   ...
   * @return admin/prestamo/cuotas/(:num)
   */
  public function show_dues($id_prestamo = false)
  {
    if ($id_prestamo) {
      ...
      $data['breadcrumb'] = $this->fn_get_BreadcrumbPage(array(array('Admin', 'admin'), array('Coutas', 'admin/prestamo')));
